...
do
    echo "starting: $pipe"
    mapshaper -i src/company_data/$pipe/poly1.json -proj EPSG:4269 -simplify $simplify_base_pct% keep-shapes -o src/company_data_min/$pipe.json precision=$simplify_prs
    echo "completed: $pipe"
done